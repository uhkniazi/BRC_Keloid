# File: write_trimmomatic_array_job.R
...
oFile.param = file('AutoScripts/trimmomatic_S032_param.txt', 'wt')
...
oFile = file('AutoScripts/trimmomatic_S032.sh', 'wt')
...
writeLines(c(cvShell, cvShell.2, cvProcessors, cvWorkingDir, cvJobName, cvStdout, cvMemoryReserve), oFile)
writeLines('\n\n', oFile)
