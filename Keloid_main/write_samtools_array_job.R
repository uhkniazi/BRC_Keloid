...
cvWorkingDir = '#$ -cwd'
cvJobName = '#$ -N samtools-array-S021'
cvStdout = '#$ -j y'
...
oFile.param = file('AutoScripts/samtools_S021_param.txt', 'wt')
...
oFile = file('AutoScripts/samtools_S021.sh', 'wt')
...
number=$SGE_TASK_ID
paramfile=samtools_S021_param.txt
